					...
					<MainContent>
						...
						<FiltersRow>
							...
							<FilterButton
								...
								onClick={() =>
									setSelectedType(
										selectedType === JournalEntryType.TASK
											? undefined
							...
							<FilterButton
								...
								onClick={() =>
									setSelectedType(
										selectedType === JournalEntryType.TOPIC
											? undefined
											: JournalEntryType.TOPIC,
									)
								}
							>
								Темы
							...
							<FilterButton
								...
								onClick={() =>
									setSelectedType(
										selectedType === JournalEntryType.IDEA
											? undefined
										...
										{regularEntries.length > 0 && (
											<div
												style={{
													...
													padding: '0.75rem',
													borderTop: '2px solid rgba(55, 65, 81, 0.6)',
												}}
											>
												<h3
													style={{
